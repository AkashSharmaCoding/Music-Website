...
<div class="container">
   ...
   <div class="collapse navbar-collapse" id="hide">
    	<ul class="nav navbar-nav navbar-right" >
        	...
        	<li class="active"><a href="jazz.php" id="head" >Jazz</a></li>
...
$query = "select * from music where type='jazz' " or die(mysql_error());
...
?>
	<div class="col-lg-4 col-md-4 col-xs-12 col-sm-6 musicbox">
	  <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            <img src="image/t2.jpg" class="img-responsive" title="<?php echo $rid[$i]['name']; ?>">
